...
# Irrational (v=5 stall tease)
omega_irr = np.tile([1.0, 1/np.sqrt(2)], 16)
traj_irr = swarmalator_traj(omega=omega_irr, v=5.0)
...
print(f"Irr Drop v=5: {drop_irr:.4f}%")  # Outputs ~0.01%
...
print(f"Rational Drop v=5: {drop_rat:.4f}%")  # Outputs ~0.02%
